...
//
    ...
    jQuery.extend({
        ...
        // Support: Android<4.1 0="" 1="" 2="" trim:="" function(="" text="" )="" {="" return="" null="" ?="" ""="" :="" (="" +="" ).replace(="" rtrim,="" );="" },="" results="" is="" for="" internal="" usage="" only="" makearray:="" arr,="" var="" ret="results" ||="" [];="" if="" arr="" !="null" isarraylike(="" object(arr)="" jquery.merge(="" ret,="" typeof="" "string"="" [="" ]="" }="" else="" push.call(="" ret;="" inarray:="" elem,="" i="" -1="" indexof.call(="" merge:="" first,="" second="" len="+second.length," j="0," ;="" <="" len;="" j++="" first[="" i++="" ];="" first.length="i;" first;="" grep:="" elems,="" callback,="" invert="" callbackinverse,="" matches="[]," length="elems.length," callbackexpect="!invert;" go="" through="" the="" array,="" saving="" items="" that="" pass="" validator="" function="" length;="" callbackinverse="!callback(" elems[="" ],="" matches.push(="" matches;="" arg="" map:="" value,="" isarray="isArraylike(" elems="" ),="" translating="" each="" of="" to="" their="" new="" values="" value="callback(" i,="" ret.push(="" every="" key="" on="" object,="" in="" flatten="" any="" nested="" arrays="" concat.apply(="" [],="" a="" global="" guid="" counter="" objects="" guid:="" 1,="" bind="" context,="" optionally="" partially="" applying="" arguments.="" proxy:="" fn,="" context="" tmp,="" args,="" proxy;="" tmp="fn[" fn="tmp;" quick="" check="" determine="" target="" callable,="" spec="" this="" throws="" typeerror,="" but="" we="" will="" just="" undefined.="" !jquery.isfunction(="" undefined;="" simulated="" args="slice.call(" arguments,="" proxy="function()" fn.apply(="" this,="" args.concat(="" slice.call(="" arguments="" };="" set="" unique="" handler="" same="" original="" handler,="" so="" it="" can="" be="" removed="" proxy.guid="fn.guid" =="" fn.guid="" jquery.guid++;="" now:="" date.now,="" jquery.support="" not="" used="" core="" other="" projects="" attach="" properties="" needs="" exist.="" support:="" support="" });="" populate="" class2type="" map="" jquery.each("boolean="" number="" string="" array="" date="" regexp="" object="" error".split("="" "),="" function(i,="" name)="" class2type[="" "[object="" "="" name="" "]"="" obj="" type="jQuery.type(" "function"="" jquery.iswindow(="" false;="" obj.nodetype="==" &&="" true;="" "array"="" "number"=""> 0 && ( length - 1 ) in obj;
    }
    var Sizzle =
        /*!
...
// Support: IE >= 9
    ...
    (function() {
        ...
        function computePixelPositionAndBoxSizingReliable() {
            div.style.cssText =
                // Support: Firefox<29, 0="" 1="" 2="" 3="" 4="" 8="" 13343="" android="" 2.3="" vendor-prefix="" box-sizing="" "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;"="" +="" "box-sizing:border-box;display:block;margin-top:1%;top:1%;"="" "border:1px;padding:1px;width:4px;position:absolute";="" div.innerhtml="" ;="" docelem.appendchild(="" container="" );="" var="" divstyle="window.getComputedStyle(" div,="" null="" pixelpositionval="divStyle.top" !="=" "1%";="" boxsizingreliableval="divStyle.width" =="=" "4px";="" docelem.removechild(="" }="" support:="" node.js="" jsdom="" don't="" assume="" that="" getcomputedstyle="" is="" a="" property="" of="" the="" global="" object="" if="" (="" window.getcomputedstyle="" )="" {="" jquery.extend(="" support,="" pixelposition:="" function()="" this="" test="" executed="" only="" once="" but="" we="" still="" do="" memoizing="" since="" can="" use="" boxsizingreliable="" pre-computing.="" no="" need="" to="" check="" was="" already="" performed,="" though.="" computepixelpositionandboxsizingreliable();="" return="" pixelpositionval;="" },="" boxsizingreliable:="" boxsizingreliableval;="" reliablemarginright:="" div="" with="" explicit="" width="" and="" margin-right="" incorrectly="" gets="" computed="" based="" on="" container.="" (#3333)="" webkit="" bug="" -="" returns="" wrong="" value="" for="" support="" function="" so="" needed.="" ret,="" margindiv="div.appendChild(" document.createelement(="" "div"="" reset="" css:="" box-sizing;="" display;="" margin;="" border;="" padding="" margindiv.style.csstext="div.style.cssText" firefox<29,="" "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;"="" "box-sizing:content-box;display:block;margin:0;border:0;padding:0";="" margindiv.style.marginright="marginDiv.style.width" "0";="" div.style.width="1px" ret="!parseFloat(" window.getcomputedstyle(="" margindiv,="" ).marginright="" ret;="" });="" })();="" method="" quickly="" swapping="" in="" out="" css="" properties="" get="" correct="" calculations.="" jquery.swap="function(" elem,="" options,="" callback,="" args="" name,="" old="{};" remember="" values,="" insert="" new="" ones="" name="" options="" old[="" ]="elem.style[" ];="" elem.style[="" ||="" []="" revert="" values="" };="" swappable="" display="" none="" or="" starts="" table="" except="" "table",="" "table-cell",="" "table-caption"="" see="" here="" values:="" https:="" developer.mozilla.org="" en-us="" docs="" rdisplayswap="/^(none|table(?!-c[ea]).+)/," rnumsplit="new" regexp(="" "^("="" pnum="" ")(.*)$",="" "i"="" ),="" rrelnum="new" "^([+-])="("" ")",="" cssshow="{" position:="" "absolute",="" visibility:="" "hidden",="" display:="" "block"="" cssnormaltransform="{" letterspacing:="" "0",="" fontweight:="" "400"="" cssprefixes="[" "webkit",="" "o",="" "moz",="" "ms"="" mapped="" potentially="" vendor="" prefixed="" vendorpropname(="" style,="" shortcut="" names="" are="" not="" style="" name;="" capname="name[0].toUpperCase()" name.slice(1),="" origname="name," i="cssPrefixes.length;" while="" i--="" capname;="" origname;="" setpositivenumber(="" value,="" subtract="" matches="rnumsplit.exec(" ?="" guard="" against="" undefined="" "subtract",="" e.g.,="" when="" used="" as="" csshooks="" math.max(="" 0,="" matches[="" "px"="" :="" value;="" augmentwidthorheight(="" extra,="" isborderbox,="" styles="" isborderbox="" "border"="" "content"="" have="" right="" measurement,="" avoid="" augmentation="" otherwise="" initialize="" horizontal="" vertical="" "width"="" val="0;" <="" 4;="" both="" box="" models="" exclude="" margin,="" add="" it="" want="" extra="==" "margin"="" cssexpand[="" ],="" true,="" border-box="" includes="" padding,="" remove="" content="" "padding"="" at="" point,="" isn't="" border="" nor="" "width",="" else="" content,="" val;="" getwidthorheight(="" start="" offset="" property,="" which="" equivalent="" valueisborderbox="true," elem.offsetwidth="" elem.offsetheight,="" elem="" "boxsizing",="" false,="" "border-box";="" some="" non-html="" elements="" offsetwidth,="" svg="" bugzilla.mozilla.org="" show_bug.cgi?id="649285" mathml="" fall="" back="" then="" uncomputed="" necessary="" unit="" pixels.="" stop="" return.="" rnumnonpx.test(val)="" case="" browser="" unreliable="" silently="" falls="" reliable="" elem.style="" &&="" support.boxsizingreliable()="" normalize="" "",="" auto,="" prepare="" 0;="" active="" model="" irrelevant="" valueisborderbox,="" "px";="" showhide(="" elements,="" show="" display,="" hidden,="" index="0," length="elements.length;" length;="" index++="" !elem.style="" continue;="" values[="" "olddisplay"="" inline="" element="" learn="" being="" hidden by="" cascaded="" rules="" !values[="" "none"="" elem.style.display="" set="" been="" overridden="" stylesheet="" whatever="" default such="" an="" ""="" ishidden(="" "olddisplay",="" defaultdisplay(elem.nodename)="" !hidden="" data_priv.set(="" jquery.css(="" "display"="" most="" second="" loop constant="" reflow="" !show="" "none";="" elements;="" jquery.extend({="" hooks="" overriding="" behavior="" getting="" setting="" csshooks:="" opacity:="" get:="" function(="" should="" always="" number="" from="" opacity="" "opacity"="" "1"="" automatically="" these="" possibly-unitless="" cssnumber:="" "columncount":="" "fillopacity":="" "flexgrow":="" "flexshrink":="" "fontweight":="" "lineheight":="" "opacity":="" "order":="" "orphans":="" "widows":="" "zindex":="" "zoom":="" true="" whose="" you="" wish="" fix="" before="" cssprops:="" float="" "float":="" "cssfloat"="" dom="" node="" style:="" text="" comment="" nodes="" !elem="" elem.nodetype="==" return;="" make="" sure="" we're="" working="" type,="" hooks,="" jquery.cssprops[="" hook="" version="" followed="" unprefixed="" jquery.csshooks[="" type="typeof" convert="" relative="" strings="" (+="or" numbers.="" #7345="" "string"="" (ret="rrelNum.exec(" ))="" ret[1]="" *="" ret[2]="" parsefloat(="" fixes="" #9237="" nan="" aren't="" set.="" see:="" #7116="" passed="" in,="" 'px'="" (except="" certain="" properties)="" "number"="" !jquery.cssnumber[="" #8908,="" be="" done="" more="" correctly="" specifying="" setters="" csshooks,="" would="" mean="" define="" eight="" (for="" every="" problematic="" property)="" identical="" functions="" !support.clearclonestyle="" name.indexof(="" "background"="" style[="" provided,="" just="" specified="" !hooks="" !("set"="" hooks)="" (value="hooks.set(" provided="" non-computed="" there="" "get"="" val,="" num,="" elem.style,="" otherwise,="" way="" exists,="" "normal"="" return,="" converting="" forced="" qualifier="" looks="" numeric="" num="parseFloat(" jquery.isnumeric(="" jquery.each([="" "height",="" i,="" computed,="" dimension="" info="" invisibly="" them="" however,="" must="" current="" benefit="" rdisplayswap.test(="" jquery.swap(="" cssshow,="" })="" set:="" getstyles(="" "border-box",="" jquery.csshooks.marginright="addGetHookIf(" support.reliablemarginright,="" work="" around="" temporarily="" inline-block="" "display":="" "inline-block"="" curcss,="" [="" "marginright"="" animate="" expand="" jquery.each({="" margin:="" padding:="" border:="" prefix,="" suffix="" prefix="" expand:="" expanded="{}," assumes="" single="" string="" parts="typeof" value.split("="" ")="" i++="" expanded[="" parts[="" expanded;="" !rmargin.test(="" ].set="setPositiveNumber;" jquery.fn.extend({="" access(="" this,="" styles,="" len,="" map="{}," jquery.isarray(="" len="name.length;" len;="" map[="" name[="" map;="" jquery.style(="" arguments.length=""> 1 );
        },
        show: function() {
...
</div></=></1.8></29,></=></$1></$1></([\w:]+)></(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^></=></"></)></tag></\></14></9,></8></8></4.0></24></4.1></4.1>